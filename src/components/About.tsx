        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <ScrollAnimation animation="fadeInLeft" delay={200}>
            <div className="space-y-6 sm:space-y-8">
              <div className="bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
          ...
          <ScrollAnimation animation="fadeInRight" delay={400}>
            <div className="space-y-6 sm:space-y-8">
              <div className="bg-gradient-to-br from-blue-600 to-red-600 p-6 sm:p-8 rounded-2xl text-white shadow-xl hover:shadow-2xl transition-all duration-300">
                <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Technical Skills</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-white/20 p-3 sm:p-4 rounded-lg backdrop-blur-sm hover:bg-white/30 transition-all duration-300">
                    <div className="text-base sm:text-lg font-semibold">HTML5</div>
                    <div className="w-full bg-white/30 rounded-full h-2 mt-2">
                      <div className="bg-white h-2 rounded-full transition-all duration-1000 ease-out" style={{ width: '95%' }}></div>
                    </div>
                  </div>
                  <div className="bg-white/20 p-3 sm:p-4 rounded-lg backdrop-blur-sm hover:bg-white/30 transition-all duration-300">
                    <div className="text-base sm:text-lg font-semibold">CSS3</div>
                    <div className="w-full bg-white/30 rounded-full h-2 mt-2">
                      <div className="bg-white h-2 rounded-full transition-all duration-1000 ease-out" style={{ width: '90%' }}></div>
                    </div>
                  </div>
                  <div className="bg-white/20 p-3 sm:p-4 rounded-lg backdrop-blur-sm hover:bg-white/30 transition-all duration-300">
                  ...
                  <div className="bg-white/20 p-3 sm:p-4 rounded-lg backdrop-blur-sm hover:bg-white/30 transition-all duration-300">
                    ...
                    <div className="w-full bg-white/30 rounded-full h-2 mt-2">
                      <div className="bg-white h-2 rounded-full transition-all duration-1000 ease-out" style={{ width: '80%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-800 to-red-800 p-6 sm:p-8 rounded-2xl text-white shadow-xl hover:shadow-2xl transition-all duration-300">
                <div className="text-center">
                  ...
                  <div className="mt-4 flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-4">
                    <div className="bg-white/20 px-3 sm:px-4 py-2 rounded-full hover:bg-white/30 transition-all duration-300">
